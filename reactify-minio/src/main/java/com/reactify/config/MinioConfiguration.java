...
import com.reactify.MinioProperties;
 ...
 *
 * <p>
 * This configuration class initializes a {@link MinioClient} bean based on the
 * properties defined in {@link MinioProperties}. It enables the Minio client
 * only if the "minio.enabled" property is set to true.
 * </p>
 *
 * @author hoangtien2k3
 */
...
public class MinioConfiguration {
    ...
    /**
     * <p>
     * Creates a {@link MinioClient} bean configured with the Minio server endpoint
     * and access credentials. The client is only created if the "minio.enabled"
     * property is set to true.
     * </p>
     *
     * @return a {@link MinioClient} object configured to connect to the Minio
     *         server.
