 ...
 */
package com.reactify.properties;
...
public class KeycloakClientProperties extends WebClientProperties {
    ...
    public KeycloakClientProperties(KeyCloakProperties auth) {
        this.auth = auth;
    }

    public KeyCloakProperties getAuth() {
        return auth;
    }

    public void setAuth(KeyCloakProperties auth) {
        this.auth = auth;
    }
}
