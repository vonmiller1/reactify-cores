 ...
 */
package com.reactify.security.keycloak;
 ...
 * {@link Converter} that converts a JWT token issued by Keycloak into a
 * collection of Spring Security
...
public class KeycloakGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
     ...
     * @param clientId
     *            a {@link String} representing the client ID for which roles are to
     *            be extracted
     * @return a {@link List} of client roles, or an empty list if none are found
     */
    @SuppressWarnings("unchecked")
